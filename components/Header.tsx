...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-20 bg-white/90 backdrop-blur-md shadow-sm border-b border-gray-200">
      <div className="max-w-7xl mx-auto px-3 py-2 sm:px-4 sm:py-3 flex items-center justify-between gap-3 sm:gap-4">
        {/* Kiri: Nama customer */}
        <button
        ...
        >
          ...
          <div className="text-left">
            ...
            <h1 className="text-base sm:text-lg font-bold text-gray-800 truncate max-w-[140px] sm:max-w-xs">
